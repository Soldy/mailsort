...
def create():
  ...
  creator = tools.Creator(conf.file_cache)
  creator.createNamed(
    conf.table_cache_names
  )
  creator.createNamed(
    conf.table_cache_domains
  )
  creator.createNamed(
    conf.table_cache_subjects
  )
  creator.close()
  
  creator = tools.Creator(conf.file_header)
  creator.createNamed(
    conf.table_header_types
  )
  creator.close()

  creator = tools.Creator(conf.file_word)
  creator.createNamed(
    conf.table_word_words
  )
  creator.close()
